<template>
  <svg x="0px" y="0px" :width="width" :height="height" viewBox="0 0 496.158 496.158" xml:space="preserve">
    <path :style="{ fill: bg }" d="M496.158,248.085c0-137.021-111.07-248.082-248.076-248.082C111.07,0.002,0,111.062,0,248.085
      c0,137.002,111.07,248.071,248.083,248.071C385.088,496.155,496.158,385.086,496.158,248.085z"/>
    <path :style="{ fill: color }" d="M370.805,235.242L195.856,127.818c-4.776-2.934-11.061-3.061-15.951-0.322
