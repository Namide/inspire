  ...
  <div class="modal">
    ...
    <div class="box">
      ...
      <div v-if="state === 0">
        ...
        <template v-else>
          <InputTextarea @submit="validContent" :value="contentRaw" @change="argValue => contentRaw = argValue" placeholder="Content (URL, markdown, HTML, embed...)"></InputTextarea>
...
import SetPostContent from '@/pure/SetPostContent'
